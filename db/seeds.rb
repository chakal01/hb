...
Constant.create(key: 'text_contact', label: "Texte contact", help: "Le texte qui sera sur la page contact.")
Constant.create(key: 'text_accueil', label: "Texte accueil", help: "Le texte qui sera sur la page d'accueil.")
